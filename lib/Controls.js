  ...
  _createClass(Controls, [{
    ...
    value: function init() {
      ...
      if (this._opts.controls === true) {
        ...
        this._prev.innerHTML = (0, _parseEs6Template2.default)(this._opts.controls, { label: 'previous slide' });
        this._next.innerHTML = (0, _parseEs6Template2.default)(this._opts.controls, { label: 'next slide' });
      }
